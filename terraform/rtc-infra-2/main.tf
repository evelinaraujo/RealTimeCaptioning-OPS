...
module "load-balancer" {
  ...
  public_subnets    = ["${data.terraform_remote_state.subnet.public_subnet_2a-id}}", "${data.terraform_remote_state.subnets.public_subnet_2b-id}", "${data.terraform_remote_state.subnets.public_subnet_2a-id}}"]
